function [phi,x,y] = airfoilBCsmod(phi,ex,ey,zx,zy,imax,jmax,x,y,farfield)
%   Deals with boundary conditions for CFD project
    j = 1; % define phi for j = 1, only do first
    for i = 2:imax-1
